              ...
              {cart.length === 0 ? (
                ...
                cart.map((item) => {
                  ...
                  return (
                    <div
                      key={item.id}
                      className="bg-cardcream border border-hairline rounded-2xl p-3.5 flex items-center justify-between gap-3 shadow-xs"
                    >
                      <div className="w-12 h-12 bg-paper rounded-xl flex items-center justify-center overflow-hidden flex-shrink-0 border border-hairline/60">
                        {item.image2D ? (
                          <img
                            src={item.image2D}
                            alt={item.name}
                      ...
                      <div className="flex-1 min-w-0">
                        <h4 className="font-serif font-semibold text-xs text-ink truncate">
                          {item.name}
                        </h4>
                      ...
                      <div className="flex items-center gap-2 flex-shrink-0">
                        <div className="flex items-center bg-paper border border-hairline rounded-lg overflow-hidden">
                          <button
                            onClick={() => updateCartQuantity(item.id, -1)}
                            className="p-1 hover:bg-cardcream text-ink transition-colors"
                          >
                          ...
                          <button
                            ...
                            className="p-1 hover:bg-cardcream text-ink transition-colors disabled:opacity-30"
                          >
                        ...
                        <button
                          ...
                          className="p-1.5 text-kumkum hover:bg-kumkum/10 rounded-lg transition-colors"
                          title="Remove item"
                        >
